        ...
        return(
            <div className="col-sm-12 col-md-6 mx-auto">
                ...
                <div className="card bg-light mb-3 border-info mx-auto shadow" >
                    <img className="card-img-top mx-auto d-block img-fluid" src={path.join(__dirname, `pokemons/${(this.state.id <= 720) ? this.state.id : this.state.id%100+1}.png`)} alt="pokemon" />
